...
/*function register(){
	...
	let b = document.rf.name.value;
	
	if(b==null){
		document.getELementById("r1").innerHTML="Enter Your Name";
		a=false;
	}
	...
	function register(){
		var user_name = document.forms["rf"]["name"].value;
		var a = /^[A-Za-z]{3,15}$/;
		...
		var phone = document.forms["rf"]["phone"].value;
		...
		var password = document.forms["rf"]["password"].value;
...
<body>
  ...
  <section class="contact_section layout_padding-bottom">
    <div class="container">
      <div class="heading_container">
        <h2 style="margin:100px 0px 0px 0px;text-align:center">Register</h2>
      </div>
      <div class="row">
        <div class="col-md-7">
          <div class="form_container">
            <form name="rf" method="POST" action="insert-reg.php" onSubmit="return register();">
              <div>
